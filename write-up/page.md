# 🟩 The Completeness Badge Power-Up for Trello
...
* ✅ **Track Checklist Progress** — Measure completion based on checklist items, including partial progress on each checklist.
* 🎨 **Custom Badge Colors & Trello Labels** — Automatically apply colors and labels based on progress (e.g., 50% = yellow + “half-way” label).
* 🔍 **Filter Cards by Completeness Labels** — Use Trello’s filtering system to see cards by progress state.
* 📊 **Charts** — Visualize your board or list with stunning visual dashboards ✨
* 🔢 **Sort** — Organize your cards by completeness ⬆️⬇️
* ✨ **Stats & Reports** — Dive into fascinating insights across lists and boards 📊
...
These features make it easy to track your projects **from task-level progress to board-wide management insights**.
...
3. ✅ **Track Checklist Progress** — optionally use a checklist to see card completion automatically.
4. 🎨 **Change the color & apply labels** — use Trello labels to mark milestones like “half-way.”
5. 🤝 **Switch to Team Mode** for consistent progress visuals across all members.
6. ⚡ **Automate & Analyze** — use reports, sorting, and charts to keep your board in sync and on track.
...
For more information, you can also access it from Power-Up Settings, and the **About** tab, click the **Subscription Information** button to find out more. Or, you can [visit our website here](https://kryl.com/?page=/subscription1).
